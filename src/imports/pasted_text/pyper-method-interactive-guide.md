...
* Health logs should be prepared for authenticated secure storage, not localStorage as the permanent system
...
All health log tables should include:
...
* every health log belongs to one user
...
* block public read access to health logs
* block public write access to health logs
