...
export function createInitialHealthContext(): HealthContextState {
  return {
    ...
    bodyMetrics: {
      heightInches: 67,
      startingWeightLb: 184,
      currentWeightLb: 173,
      goalWeightLb: 160,
      highestAdultWeightLb: 198,
      lowestAdultWeightLb: 155,
      waist: 32,
      hips: 38,
      chest: 38,
      arm: 12,
      thigh: 22,
      weightChange12Months: "Down approximately 11 lb",
      unexplainedChange: "",
      clothingFit: "Improving through waist and hips",
      notes: "",
    },
    conditions: [],
    multiSelect: {},
    medications: [
      {
        id: uid("med"),
        name: "Semaglutide",
        category: "GLP-1 or weight-management medication",
        formulation: "Injection",
        dose: "As prescribed",
        frequency: "Weekly",
        startDate: "2026-01-12",
        endDate: "",
        reason: "Clinician-guided metabolic support",
        prescriber: "Prescribing clinician",
        currentlyTaking: true,
        observedChanges: "Appetite quieter; protein focus required",
        sideEffects: "Mild post-dose nausea early weeks",
        notesForProvider: "",
    ...
    timeline: [
      {
        id: uid("tl"),
        label: "Health Context opened (prototype demo data)",
